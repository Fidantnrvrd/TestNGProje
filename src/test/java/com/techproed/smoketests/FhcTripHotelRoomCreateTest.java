...
import pages.FhcTripHotelRoomCreatePage;
...
public class FhcTripHotelRoomCreateTest extends TestBase {
    ...
    public void giris() {
        ...
        public void test01 () {
            ...
            // ConfigurationReader class'ina diyoruski, .properties dosyasinin icerisindeki
            // room_create_url (anahtarinin) degerini al.
            // room_create_url  = http://http://fhctrip-qa.com/admin/HotelroomAdmin/Create
            ...
            page.nameKutusu.sendKeys("Fidan Tanriverdi");
            ...
            Select select1 = new Select(page.igGroupRoomTypeDropDown);
